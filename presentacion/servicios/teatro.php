...
<head>
    ...
    <style>
        ...
        .hero-section {
            background-image: url('../img/img-teatro.png');
...
<body class="bg-[#18191b] text-gray-800">
    ...
    <section class="hero-section h-64 flex items-center justify-center text-center">
        <div class="hero-text-bg">
            <h1 class="text-4xl font-bold text-white mb-4">Teatro</h1>
            <p class="text-lg text-white mb-8">Ideal para representaciones teatrales y espectáculos con un excelente ambiente.</p>
        </div>
    </section>
    ...
    <section class="container mx-auto py-16">
        <div class="flex flex-col md:flex-row items-center md:items-start">
            <div class="md:w-1/2 mb-8 md:mb-0">
                <img src="../img/teatro.png" alt="Teatro" class="event-image w-full object-cover">
            </div>
            <div class="md:w-1/2 md:pl-8">
                <h2 class="text-3xl font-bold mb-4">Detalles del Teatro</h2>
                <p class="text-lg mb-4">Nuestro salón de teatro está diseñado para ofrecer una experiencia única en cada presentación. Con una excelente acústica y una atmósfera envolvente, es el lugar perfecto para eventos teatrales, espectáculos y presentaciones en vivo.</p>
                <p class="text-lg mb-4">Desde representaciones teatrales hasta eventos culturales, nuestro espacio se adapta a tus necesidades con una disposición flexible y un ambiente acogedor.</p>
                <ul class="list-disc list-inside mb-4">
                    <li>Capacidad: 180 Personas</li>
                    <li>Acústica de Alta Calidad</li>
                    <li>Iluminación Escénica Adaptable</li>
                    <li>Espacio para Escenario y Asientos</li>
                </ul>
