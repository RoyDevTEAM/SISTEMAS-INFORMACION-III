...
<head>
    ...
    <title>Concierto - Salón de Eventos</title>
    ...
    <style>
        ...
        .hero-section {
            background-image: url('../img/img-concierto.png');
...
<body class="bg-[#18191b] text-gray-800">
    ...
    <section class="hero-section h-64 flex items-center justify-center text-center">
        <div class="hero-text-bg">
            <h1 class="text-4xl font-bold text-white mb-4">Concierto</h1>
            <p class="text-lg text-white mb-8">Disfruta de eventos musicales con la mejor acústica y ambiente.</p>
        </div>
    </section>
    ...
    <section class="container mx-auto py-16">
        <div class="flex flex-col md:flex-row items-center md:items-start">
            <div class="md:w-1/2 mb-8 md:mb-0">
                <img src="../img/concierto.png" alt="Concierto" class="event-image w-full object-cover">
            </div>
            <div class="md:w-1/2 md:pl-8">
                <h2 class="text-3xl font-bold mb-4">Detalles del Concierto</h2>
                <p class="text-lg mb-4">Nuestro salón ofrece el ambiente perfecto para conciertos y eventos musicales. Con una acústica de primera clase y un diseño que realza cada nota, tu evento musical será una experiencia inolvidable para todos los asistentes.</p>
                <p class="text-lg mb-4">Disfruta de nuestras instalaciones diseñadas para ofrecer el mejor sonido y comodidad. Contamos con un equipo de soporte dedicado para garantizar que cada detalle esté a la altura de tus expectativas.</p>
                <ul class="list-disc list-inside mb-4">
                    <li>Capacidad: 250 Personas</li>
                    <li>Acústica de Alta Calidad</li>
                    <li>Escenario y Equipos de Sonido</li>
